...
class Klaviyo {
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(address1: addr)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(address2: addr)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(city: city)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(country: country)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(latitude: lat)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(longitude: lng)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(region: region)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(zip: zip)) instead. '
    'Will be removed in 2.0.',
  )
  ...
  @Deprecated(
    'Use KlaviyoSDK().setLocation(KlaviyoLocation(timezone: tz)) instead. '
    'Will be removed in 2.0.',
  )
