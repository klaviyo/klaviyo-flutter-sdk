...
class KlaviyoProfileException extends KlaviyoException {
  const KlaviyoProfileException(String message,
...
class KlaviyoEventException extends KlaviyoException {
  const KlaviyoEventException(String message,
      {dynamic originalError, StackTrace? stackTrace})
      : super(message,
            code: 'EVENT_ERROR',
            originalError: originalError,
...
class KlaviyoPushException extends KlaviyoException {
  const KlaviyoPushException(String message,
      {dynamic originalError, StackTrace? stackTrace})
      : super(message,
            code: 'PUSH_ERROR',
            originalError: originalError,
...
class KlaviyoFormException extends KlaviyoException {
  const KlaviyoFormException(String message,
      {dynamic originalError, StackTrace? stackTrace})
      : super(message,
            code: 'FORM_ERROR',
            originalError: originalError,
...
class KlaviyoConfigurationException extends KlaviyoException {
  const KlaviyoConfigurationException(String message,
      {dynamic originalError, StackTrace? stackTrace})
      : super(message,
...
class KlaviyoPermissionException extends KlaviyoException {
  const KlaviyoPermissionException(String message,
      {dynamic originalError, StackTrace? stackTrace})
      : super(message,
