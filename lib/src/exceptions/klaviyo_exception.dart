...
class KlaviyoNotInitializedException extends KlaviyoException {
  const KlaviyoNotInitializedException([String message = 'Klaviyo SDK is not initialized'])
...
class KlaviyoInvalidApiKeyException extends KlaviyoException {
  const KlaviyoInvalidApiKeyException([String message = 'Invalid or missing API key'])
...
class KlaviyoProfileException extends KlaviyoException {
  const KlaviyoProfileException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'PROFILE_ERROR', originalError: originalError, stackTrace: stackTrace);
}

/// Exception thrown when event tracking fails
class KlaviyoEventException extends KlaviyoException {
  const KlaviyoEventException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'EVENT_ERROR', originalError: originalError, stackTrace: stackTrace);
}

/// Exception thrown when push notification operations fail
class KlaviyoPushException extends KlaviyoException {
  const KlaviyoPushException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'PUSH_ERROR', originalError: originalError, stackTrace: stackTrace);
}

/// Exception thrown when form operations fail
class KlaviyoFormException extends KlaviyoException {
  const KlaviyoFormException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'FORM_ERROR', originalError: originalError, stackTrace: stackTrace);
}

/// Exception thrown when configuration is invalid
class KlaviyoConfigurationException extends KlaviyoException {
  const KlaviyoConfigurationException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'CONFIGURATION_ERROR', originalError: originalError, stackTrace: stackTrace);
}

/// Exception thrown when permissions are not granted
class KlaviyoPermissionException extends KlaviyoException {
  const KlaviyoPermissionException(String message, {dynamic originalError, StackTrace? stackTrace})
      : super(message, code: 'PERMISSION_ERROR', originalError: originalError, stackTrace: stackTrace);
} 